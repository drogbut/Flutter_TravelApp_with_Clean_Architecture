...
abstract class $ArrivalCopyWith<$Res> {
  ...
  @useResult
  $Res call({String? iataCode, String? at});
}
...
class _$ArrivalImpl implements _Arrival {
  const _$ArrivalImpl({required this.iataCode, this.at});
  ...
  @override
  String toString() {
    return 'Arrival(iataCode: $iataCode, at: $at)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, iataCode, at);
...
abstract class _Arrival implements Arrival {
  const factory _Arrival({required final String? iataCode, final String? at}) =
      _$ArrivalImpl;
